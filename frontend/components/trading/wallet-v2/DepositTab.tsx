...
export const DepositTab: React.FC<Props> = ({
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-2">
        <div className="space-y-4">
            <div className="p-6 bg-green-100 dark:bg-green-900/20 border-2 border-black dark:border-green-500 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.5)] rounded-xl">
