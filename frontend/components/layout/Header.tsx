...
import { Menu, Sun, Moon, Home, MessageSquare, User, Bot, Wallet, LogOut, ChevronDown, HelpCircle, Snowflake } from 'lucide-react';
import { formatAddress } from '../../services/web3Service';
import WalletModal from '../modals/WalletModal';

export type ViewType = 'landing' | 'chat' | 'profile' | 'auto-trade';
