...
const ProfileStats: React.FC<ProfileStatsProps> = ({ 
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {/* User Card */}
      <div className="md:col-span-2 bg-white dark:bg-[#1a1a1a] border-2 border-black dark:border-white shadow-neo p-6 relative overflow-hidden">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10">
          <div className="w-24 h-24 bg-neo-primary border-2 border-black dark:border-white flex items-center justify-center shrink-0 shadow-neo-sm">
          ...
          <div className="text-center md:text-left space-y-2 flex-1">
            ...
            <div className="flex flex-col md:flex-row items-center gap-3">
              {isEditingEmail ? (
                <div className="flex items-center gap-2">
                    <input 
                        ...
                        className="bg-white dark:bg-black border-2 border-black dark:border-white px-2 py-1 text-sm font-mono font-bold outline-none shadow-neo-sm"
                        autoFocus
                    />
                    <button onClick={handleSaveEmail} className="p-1 bg-green-500 border-2 border-black text-white hover:scale-105 transition-transform">
                        <Check className="w-3 h-3" />
                    </button>
                    <button onClick={() => { setIsEditingEmail(false); setTempEmail(user.email); }} className="p-1 bg-red-500 border-2 border-black text-white hover:scale-105 transition-transform">
                        <X className="w-3 h-3" />
                    </button>
                </div>
              ) : (
              ...
              <span className="text-xs font-black bg-gray-200 dark:bg-gray-800 px-2 py-0.5 border border-black dark:border-gray-600">
            ...
            <div className="pt-2">
              {user.walletAddress ? (
                <div className="flex items-center justify-center md:justify-start gap-2">
                  <div className="flex items-center gap-2 bg-green-100 dark:bg-green-900/30 border-2 border-black dark:border-green-500 px-3 py-1.5">
                ...
                <div className="flex items-center justify-center md:justify-start gap-2 text-gray-500">
                   <div className="bg-gray-200 dark:bg-gray-800 p-2 border border-dashed border-black dark:border-gray-600 flex items-center gap-2">
      ...
      {/* Total Balance Card */}
      <div className="bg-neo-secondary border-2 border-black dark:border-white shadow-neo p-6 flex flex-col justify-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="mt-4 flex items-center gap-2">
            <div className="bg-black text-white px-2 py-0.5 text-xs font-bold uppercase transform -rotate-1">
              Real-Time
            </div>
          </div>
        </div>
