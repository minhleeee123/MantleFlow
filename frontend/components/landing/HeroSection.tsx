    ...
    <div className="relative border-b-2 border-black dark:border-white w-full flex flex-col shrink-0 overflow-hidden min-h-[700px] justify-center">
      ...
      <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full md:w-auto">
          <button 
            onClick={onStart}
            className="group relative px-8 py-5 bg-neo-primary text-white border-2 border-black dark:border-white font-black text-xl uppercase shadow-neo hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-none transition-all flex items-center justify-center gap-3 overflow-hidden"
          >
          ...
          <button className="px-8 py-5 bg-white dark:bg-[#1a1a1a] text-black dark:text-white border-2 border-black dark:border-white font-black text-xl uppercase shadow-neo hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-none transition-all">
            View Live Demo
          </button>
        </div>
      </div>
